...
const Datenschutz = () => (
  <div>
    ...
    <section class="section contenedor intro">
        ...
        <p><b>Datenschutzerklärung für die Nutzung von Piwik</b></p>

        <p>Diese Webseite nutzt auch die Open-Source-Software des Webanalysedienst Piwik für die statistische Auswertung von Besucherzugriffen. Die von Piwik erfassten Daten werden nicht und niemals auf andere Server übertragen oder an Dritte weitergegeben, sondern in anonymisierter Form dazu verwendet, unser Angebot zu verbessern. IP-Adressen werden in Piwik ohne das letzte Tupel gespeichert. Wir wissen, aus welchem Netz eine Anfrage kam, nicht jedoch von welchem Rechner. Durch die Nutzung dieser Website erklären Sie sich mit der Verarbeitung der über Sie erhobenen Daten durch Piwik in der zuvor beschriebenen Art und Weise und zu dem zuvor benannten Zweck einverstanden. Sie haben allerdings die Möglichkeit dass Cookies von Piwik auf Ihrem Computer nicht gespeichert werden: sofern Ihr Browser die "Do-Not-Track"-Technik unterstützt und Sie diese aktiviert haben, wird ihr Besuch automatisch ignoriert. Dies kann aber dazu führen, dass Sie unsere Internetseite nicht im kompletten Umfang nutzen können.</p>
